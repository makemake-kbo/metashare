...
static const Glyph kFont[] = {
    // '0'-'0' keeps the index symmetric with the other digit entries below.
    // NOLINTNEXTLINE(misc-redundant-expression)
    ['0' -
     '0'] = {{0b01110, 0b10001, 0b10011, 0b10101, 0b11001, 0b10001, 0b01110}},
    ['1' - '0'] = {{0b00100, 0b01100, 0b00100, 0b00100, 0b00100, 0b00100,
                    0b01110}},
    ['2' - '0'] = {{0b01110, 0b10001, 0b00001, 0b00110, 0b01000, 0b10000,
                    0b11111}},
    ['3' - '0'] = {{0b11111, 0b00010, 0b00100, 0b00010, 0b00001, 0b10001,
                    0b01110}},
    ['4' - '0'] = {{0b00010, 0b00110, 0b01010, 0b10010, 0b11111, 0b00010,
                    0b00010}},
    ['5' - '0'] = {{0b11111, 0b10000, 0b11110, 0b00001, 0b00001, 0b10001,
                    0b01110}},
    ['6' - '0'] = {{0b00110, 0b01000, 0b10000, 0b11110, 0b10001, 0b10001,
                    0b01110}},
    ['7' - '0'] = {{0b11111, 0b00001, 0b00010, 0b00100, 0b01000, 0b01000,
                    0b01000}},
    ['8' - '0'] = {{0b01110, 0b10001, 0b10001, 0b01110, 0b10001, 0b10001,
                    0b01110}},
    ['9' - '0'] = {{0b01110, 0b10001, 0b10001, 0b01111, 0b00001, 0b00010,
                    0b01100}},
};
...
void draw_label(std::uint8_t* base, int stride, int w, int h, int mon) {
    ...
    for (char* p = text; *p; ++p) {
        ...
        if (c == 'M') {
            // Custom M
            static const Glyph M = {{0b10001, 0b11011, 0b10101, 0b10001,
                ...
                for (int dy = 0; dy < scale; ++dy) {
                    for (int dx = 0; dx < scale; ++dx) {
                        ...
                        if (px_x < 0 || px_x >= w || px_y < 0 || px_y >= h)
                            continue;
                        auto* px = base + (std::size_t)px_y * stride +
                                   (std::size_t)px_x * 4;
                        px[0] = 0;    // B
                        px[1] = 255;  // G
                        px[2] = 255;  // R - cyan
    ...
    const int by =
        (h - box) > 0
            ? static_cast<int>((idx * 4) %
                               (2 * static_cast<std::int64_t>(h - box)))
            : 0;
